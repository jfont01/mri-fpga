    ...
    NBF_A="${NBF_A_LIST[$j]}"
      for k in "${!NB_B_LIST[@]}"; do
        ...
        for l in "${!NB_S_LIST[@]}"; do
          ...
          OUTPUT_DIR="$PY_SENSE_REPORTER_DIR/output/N${N}_Af${AF}_L${L}_axis${AXIS}_${PHANTOM}/NB_Y${NB_K}_NBF_Y${NBF_K}-NB_S${NB_S}_NBF_S${NBF_S}-NB_A${NB_A}_NBF_A${NBF_A}-NB_B${NB_B}_NBF_B${NBF_B}"
          mkdir -p "$OUTPUT_DIR"

          FP_DIR="$PY_SENSE_ROOT/fp/output/N${N}_Af${AF}_L${L}_axis${AXIS}_${PHANTOM}"
          FXP_DIR="$PY_SENSE_ROOT/fxp/output/N${N}_Af${AF}_L${L}_axis${AXIS}_${PHANTOM}/NB_Y${NB_K}_NBF_Y${NBF_K}-NB_S${NB_S}_NBF_S${NBF_S}-NB_A${NB_A}_NBF_A${NBF_A}-NB_B${NB_B}_NBF_B${NBF_B}"
