...
# Paths de salida
###########################################################################
OUTPUT_DIR="$SENSE_GEN_DIR/output"
...
python3 "$SENSE_GEN_DIR/gen_phantom.py" \
  -N="$N" -A="$AMP" \
...
python3 "$SENSE_GEN_DIR/gen_smaps.py" \
  -N="$N" \
  -L="$L" \
...
python3 "$SENSE_GEN_DIR/gen_coils.py" \
...
python3 "$SENSE_GEN_DIR/gen_kspace.py" \
...
python3 "$SENSE_GEN_DIR/gen_aliased_kspace.py" \
...
python3 "$SENSE_GEN_DIR/gen_coil_aliased.py" \
