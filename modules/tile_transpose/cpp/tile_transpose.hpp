 ...
 * Example:
 *
 * #ifndef TILE_TRANSPOSE_NB_IN
 * #define TILE_TRANSPOSE_NB_IN 16
 * #endif
 *
 * #ifndef TILE_TRANSPOSE_NBF_IN
 * #define TILE_TRANSPOSE_NBF_IN 14
 * #endif
 *
 * #ifndef TILE_TRANSPOSE_NB_OUT
 * #define TILE_TRANSPOSE_NB_OUT 16
 * #endif
 *
 * #ifndef TILE_TRANSPOSE_NBF_OUT
 * #define TILE_TRANSPOSE_NBF_OUT 14
 * #endif
 */
...
enum parameters : int {
     ...
     * Example:
     *
     * NB_IN   = TILE_TRANSPOSE_NB_IN,
     * NBF_IN  = TILE_TRANSPOSE_NBF_IN,
     * NB_OUT  = TILE_TRANSPOSE_NB_OUT,
     * NBF_OUT = TILE_TRANSPOSE_NBF_OUT
     */
};
...
class tile_transpose_model final : public rtl::Module {
public:
    tile_transpose_model() = default;
