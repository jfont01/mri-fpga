 ...
 * Example:
 *
 * #ifndef DELAY_LINE_NB_IN
 * #define DELAY_LINE_NB_IN 16
 * #endif
 *
 * #ifndef DELAY_LINE_NBF_IN
 * #define DELAY_LINE_NBF_IN 14
 * #endif
 *
 * #ifndef DELAY_LINE_NB_OUT
 * #define DELAY_LINE_NB_OUT 16
 * #endif
 *
 * #ifndef DELAY_LINE_NBF_OUT
 * #define DELAY_LINE_NBF_OUT 14
 * #endif
 */
...
enum parameters : int {
     ...
     * Example:
     *
     * NB_IN   = DELAY_LINE_NB_IN,
     * NBF_IN  = DELAY_LINE_NBF_IN,
     * NB_OUT  = DELAY_LINE_NB_OUT,
     * NBF_OUT = DELAY_LINE_NBF_OUT
     */
};
...
class delay_line_model final : public rtl::Module {
public:
    delay_line_model() = default;
